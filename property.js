class PropertyManager {
  ...
  // Function to get the property index in JSON format
  getPropertyIndex() {
  ...
  // Save the property list to the database
  async save() {
  ...
  // Load the property list from the database
  async load() {
    try {
