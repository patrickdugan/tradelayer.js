 ...
 * @returns {string}
 */
export function verifier_limits_json() {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {string}
 */
export function verify_checkpoint_announcement_json(announcement_json) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function verify_stwo_cairo_proof_json(proof_json, channel_hash, expected_sha256_hex) {
    let deferred4_0;
    let deferred4_1;
    try {
 ...
 * @returns {string}
 */
export function verify_zk_consensus_envelope_json(envelope_json) {
    let deferred2_0;
    let deferred2_1;
    try {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tlzk_verifier_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
