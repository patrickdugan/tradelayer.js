...
async function runExample() {
    ...
    const positionHistory2 = await tradeHistoryManager.getPositionHistoryForContract(address2, contractId);
    console.log(`Position History for Address ${address2} and Contract ID ${contractId}:`);
    console.table(positionHistory2);


    const positionHistory3 = await tradeHistoryManager.getPositionHistoryForContract(address3, contractId);
