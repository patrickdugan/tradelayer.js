...
async function generateTrades(adminAddress) {
    ...
    const btcPrice = 45000; // Base price for BTC
    ...
    for (let i = 0; i < 1; i++) { // Generate 10 random trades
        ...
        const amount = Math.floor(Math.random() * 1000) + 1; // Random amount between 1 and 10
        ...
        await TxUtils.createContractOnChainTradeTransaction(adminAddress, tradeParams);
    }
}

// Address for the trades
const adminAddress = 'tltc1q8xw3vsvkv77dpj59nqn30rxlc9m3xjw76cgrac'
