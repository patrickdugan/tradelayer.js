...
async function generateTrades(adminAddress) {
    ...
    const btcPrice = 41900; // Base price for BTC
    ...
    for (let i = 0; i < 1; i++) { // Generate 10 random trades
        ...
        const amount = Math.floor(Math.random() * 4) + 1; // Random amount between 1 and 10
...
const adminAddress = 'tltc1q7r6x4v67n8vnaftnz8pk33yvf9t9gpynuwdfgk'//"tltc1q7r6x4v67n8vnaftnz8pk33yvf9t9gpynuwdfgk";
